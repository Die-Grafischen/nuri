...
// > Could be something like "nuri.local" or "localhost"
// > depending upon your local WordPress setup.
const projectURL = 'https://nuri.local';
...
const textDomain = 'nuri';

// Name of the translation file.
const translationFile = 'nuri.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'nuri';

// Where can users report bugs.
const bugReport = 'https://github.com/Die-Grafischen';

// Last translator Email ID.
const lastTranslator = 'Ivo Ivanov';

// Team's Email ID.
const team = 'Die Grafischen';
