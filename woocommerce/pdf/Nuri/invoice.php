...
<table class="order-details">
    <thead>
        <tr>
            ...
            <th class="mvst"><?php _e( 'MwSt.', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
        </tr>
    </thead>
    <tbody>
        <?php foreach ( $this->get_order_items() as $item_id => $item ) : ?>
        <tr
            class="<?php echo apply_filters( 'wpo_wcpdf_item_row_class', 'item-'.$item_id, $this->get_type(), $this->order, $item_id ); ?>">
            <td class="product" style="width: 46%">
            ...
            <td class="quantity" style="width:20%"><?php echo $item['quantity']; ?></td>
            <td class="price"><?php echo $item['order_price']; ?></td>
            <td class="mvst"><?php echo $item['tax_rates']; ?></td>
        </tr>
        <?php endforeach; ?>
    </tbody>
    <tfoot>
                ...
                <table class="totals">
                    <tfoot>
                        ...
                        <tr class="<?php echo $key; ?>">
                            <th class="description1" style="width:35%"><?php echo $total['label']; ?></th>
                            <td class="price1" colspan="2">
