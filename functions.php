...
require get_template_directory() . '/classes/class-nuri-script-loader.php';
...
function nuri_register_styles() {
	...
	wp_enqueue_style( 'nuri-style', get_stylesheet_uri() . '/assets/css/main.css', array(), $theme_version );
 ...
 * @return string $html
 */
function nuri_get_custom_logo( $html ) {
...
add_filter( 'get_custom_logo', 'nuri_get_custom_logo' );
